...
session_start();
 ...
 if(isset($_POST) & !empty($_POST)){
   $question = mysqli_real_escape_string($mysqli, $_POST['question']);
    ...
    $query = "INSERT INTO faq_master (title, description, userid, created, modified) VALUES ('$question', '$answer', '$userid', '$updatetime', '$updatetime')";
    $result = mysqli_query($mysqli, $query) or die(mysqli_error($mysqli));
    $lid = mysqli_insert_id($mysqli);
    if($result){
 
      $smsm = "FAQ saved Successfully.";
      header("location: edit-faq.php?id=$lid");
...
<html lang="en">
<head>
<title>CA Admin Panel - Add FAQ</title>
<meta charset="UTF-8" />
        ...
        <?php if(isset($smsm)){    ?><div class="alert alert-success">
          ...
          <form action="#" method="POST" class="form-horizontal" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="question" placeholder=" Enter here" />
                <br/> 
