...
session_start();
 ...
 $email = $mysqli->escape_string($_SESSION['adminemail']);
        ...
        //$active = $user['active'];
        $query = "SELECT * FROM emaillist ORDER BY id DESC";
...
<html lang="en">
<head>
<title>CA Admin Panel - Emails</title>
<meta charset="UTF-8" />
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  <td><?php echo $i; ?></td>
                  <td><?php echo $getpro['client']; ?></td>
                  <td><?php echo $getpro['subject']; ?></td>
                  <td><?php echo $getpro['message']; ?></td>
                  <td><?php echo $getpro['created']; ?></td>  
                  <td>
                    <a href="delete.php?id=<?php echo $getpro['id']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
