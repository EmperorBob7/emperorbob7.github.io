var ctx;
            ...
            var img = new Image();
			var blocked = new Image();
            var soget = new Image(), switchbox = new Image(), free = new Image(), opt = new Image(), shi = new Image(), sco = new Image(), ray = new Image(), kog = new Image(), speark = new Image(), egret = new Image(), ibis = new Image(), light = new Image(), viper = new Image(), hound = new Image(), aster = new Image(), mete = new Image(), escudo = new Image(), handgun = new Image(), arifle = new Image(), shot = new Image(), grenade = new Image();
            opt.src = "https://cdn.discordapp.com/attachments/571784589882949692/588223959292706817/1560313908255.png";
            shi.src = "https://cdn.discordapp.com/attachments/571784589882949692/588226241895858176/1560314451213.png";
            sco.src = "https://cdn.discordapp.com/attachments/571784589882949692/588228644481269761/1560315030622.png";
            egret.src = "https://cdn.discordapp.com/attachments/571784589882949692/591051692724977665/importantIcon.png";
            aster.src = "https://cdn.discordapp.com/attachments/571784589882949692/591053193702539314/importantIcon.png";
            handgun.src = "https://cdn.discordapp.com/attachments/571784589882949692/591054144995983425/importantIcon.png";
            kog.src = "https://cdn.discordapp.com/attachments/571784589882949692/591058852800233503/importantIcon.png";
            ray.src = "https://cdn.discordapp.com/attachments/571784589882949692/591060849754374146/importantIcon.png";
            viper.src = "https://cdn.discordapp.com/attachments/571784589882949692/591062402783772691/importantIcon.png";
            mete.src = "https://cdn.discordapp.com/attachments/571784589882949692/591063097255526400/importantIcon.png";
            hound.src = "https://cdn.discordapp.com/attachments/571784589882949692/591064834523660303/importantIcon.png";
            speark.src = "https://cdn.discordapp.com/attachments/571784589882949692/591067006355374110/importantIcon.png";
            ibis.src = "https://cdn.discordapp.com/attachments/571784589882949692/595070798725906442/importantIcon.png";
            light.src = "https://cdn.discordapp.com/attachments/571784589882949692/595071264087998496/importantIcon.png";
            escudo.src = "https://cdn.discordapp.com/attachments/571784589882949692/595073834692902925/importantIcon.png";
            arifle.src = "https://cdn.discordapp.com/attachments/571784589882949692/595073561467682818/importantIcon.png";
            shot.src = "https://cdn.discordapp.com/attachments/571784589882949692/595074859860492318/importantIcon.png";
            grenade.src = "https://cdn.discordapp.com/attachments/571784589882949692/595076936133246989/importantIcon.png";
			free.src = "https://cdn.discordapp.com/attachments/571784589882949692/596874086341410826/importantIcon.png";
			switchbox.src = "https://cdn.discordapp.com/attachments/571784589882949692/596787826511577119/importantIcon.png";
			img.src = "https://cdn.discordapp.com/attachments/571784589882949692/606222154140221441/importantIcon.png";
			blocked.src = "https://cdn.discordapp.com/attachments/571784589882949692/597287816635875338/importantIcon.png";
			soget.src = "https://cdn.discordapp.com/attachments/571784589882949692/610257477631606811/importantIcon.png";
            img.onload = function() {
            ...
            var trigImg = ["",shi,opt,ray,kog,sco,speark,aster,hound,mete,viper,egret,ibis,light,opt,opt,opt,opt,opt,escudo,opt,opt,opt,opt,opt,opt,arifle,arifle,arifle,arifle,arifle,arifle,arifle,grenade,grenade,grenade,grenade,grenade,grenade,grenade,shot,shot,shot,shot,shot,shot,shot,handgun,handgun,handgun,handgun,handgun,handgun,handgun,switchbox,opt,opt,opt,opt,soget,opt];
			...
			function RNG() {
			    var Arr = ["Shield","Bagworm","Raygust","Kogetsu","Scorpion","Kogetsu: Spear","Asteroid","Hound","Meteora","Viper","Egret","Ibis","Lightning","Gen'Yo","Lead Bullet","Senku","Starmaker","Thruster","Escudo","Chameleon","Dummy Beacon","Grasshopper","Spider","Teleporter","Switchbox","Idaten","Geist","Connector","Sogetsu","Full Arms","Assault Rifle: Viper","Assault Rifle: Hound","Assault Rifle: Asteroid","Assault Rifle: Meteora","Grenade Gun: Viper","Grenade Gun: Hound","Grenade Gun: Asteroid","Grenade Gun: Meteora","Shotgun: Viper","Shotgun: Hound","Shotgun: Asteroid","Shotgun: Meteora","Handgun: Viper","Handgun: Hound","Handgun: Asteroid","Handgun: Meteora"];
			    var Arr2 = ["Assault Rifle: Viper","Assault Rifle: Hound","Assault Rifle: Asteroid","Assault Rifle: Meteora","Grenade Gun: Viper","Grenade Gun: Hound","Grenade Gun: Asteroid","Grenade Gun: Meteora","Shotgun: Viper","Shotgun: Hound","Shotgun: Asteroid","Shotgun: Meteora","Handgun: Viper","Handgun: Hound","Handgun: Asteroid","Handgun: Meteora"];
			    var icons = [shi,opt,ray,kog,sco,speark,aster,hound,mete,viper,egret,ibis,light,opt,opt,opt,opt,opt,escudo,opt,opt,opt,opt,opt,opt,opt,opt,opt,soget,opt,arifle,arifle,arifle,arifle,grenade,grenade,grenade,grenade,shot,shot,shot,shot,handgun,handgun,handgun,handgun];
			    var def = "DEFENSE TRIGGER", atk = "ATTACKER TRIGGER", optt = "OPTION TRIGGER", snip = "SNIPER TRIGGER", shoot = "SHOOTER TRIGGER", gunne = "GUNNER TRIGGER";
			    var types = [def,optt,atk,atk,atk,atk,shoot,shoot,shoot,shoot,snip,snip,snip,optt,optt,optt,optt,optt,def,optt,optt,optt,optt,optt,optt,optt,optt,optt,optt,optt,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne,gunne];
			    for(var i = 1; i<=8; i++) {
			        var Numb = Math.floor(Math.random()*33);
			        if(Numb >= 31) {
			           var Numb2 = Math.floor(Math.random()*12) + 34;
			           triggers[i-1] = Numb2;
			        }
			        else {
			        	triggers[i-1] = Numb;
			    ...
			    for(var i = 0; i<4; i++) {
			    	ctx.font = "normal normal bold 10px Arial";
			    	ctx.fillText(types[triggers[i]],418,textY);
			    	ctx.drawImage(icons[triggers[i]],372,imgY,39,43);
			    	ctx.font = "normal normal bold 13px Arial";
			    	ctx.fillText(Arr[triggers[i]],423,nameY);
			    ...
			    for(var i = 4; i<8; i++) {
			    	ctx.font = "normal normal bold 10px Arial";
			    	ctx.fillText(types[triggers[i]],1106,textY);
			    	ctx.drawImage(icons[triggers[i]],1060,imgY,39,43);
			    	ctx.font = "normal normal bold 13px Arial";
			    	ctx.fillText(Arr[triggers[i]],1111,nameY);
